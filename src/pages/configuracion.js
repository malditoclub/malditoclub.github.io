...
export const Noticias = [
  ...
  { 
    titulo: "LA ERA DE LOS 240Hz EN MONITORES 4K", 
    introduccion: "Los nuevos paneles OLED prometen la combinación perfecta entre calidad de imagen y fluidez.",
    imagen: "vite.svg",
    texto: [
  ...
  { 
    ...
    introduccion: "Las nuevas unidades de almacenamiento prometen reducir los tiempos de carga a prácticamente cero.",
    imagen: "ssd-pcie5.jpg",
    texto: [
